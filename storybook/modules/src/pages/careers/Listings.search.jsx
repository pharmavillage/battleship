                  ...
                  <ComboboxOptions static className="max-h-96 transform-gpu scroll-py-3 overflow-y-auto p-3">
                    {filteredItems.map((item) => (
                      <ComboboxOption
                        key={item.id}
                        value={item}
                        className={({ focus }) => classNames("flex cursor-default select-none rounded-xl p-3", focus && "bg-gray-100")}
                      >
                        {({ focus }) => (
                          <>
                            ...
                            <div className="ml-4 flex-auto">
                              <p className={classNames("text-sm font-medium", focus ? "text-gray-900" : "text-gray-700")}>{item.name}</p>
                              <p className={classNames("text-sm", focus ? "text-gray-700" : "text-gray-500")}>{item.description}</p>
                            </div>
                          </>
                        )}
                      </ComboboxOption>
