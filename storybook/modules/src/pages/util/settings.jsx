...
import { Dialog, DialogPanel, Field, Label, Switch, Transition, TransitionChild } from "@headlessui/react";
import {
              ...
              >
                <DialogPanel className="relative flex w-full max-w-xs flex-1 flex-col bg-white pb-4 pt-5">
                  ...
                  <div className="flex flex-shrink-0 items-center px-4">
                    <img className="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=purple&shade=600" alt="Easywire" />
                  </div>
                        ...
                        <div className="mt-10 divide-y divide-gray-200">
                          ...
                          <div className="mt-6">
                            <dl className="divide-y divide-gray-200">
                              ...
                              <Field as="div" className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:pt-5">
                                <Label as="dt" className="text-sm font-medium text-gray-500" passive>
                                  Automatic timezone
                                </Label>
                                <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                  <Switch
                              ...
                              <Field as="div" className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-b sm:border-gray-200 sm:py-5">
                                <Label as="dt" className="text-sm font-medium text-gray-500" passive>
